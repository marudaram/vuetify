<template>
  <v-app>
    <v-card
      >shift를 사용하면 active되지 않을 때 button에 걸리는 텍스트를
      숨겨버린다</v-card
    >
    ...
    <v-card
      >v-bottom-navigation부분에 :input-value="active"로 주고(data에는
      active=true로 선언한다), 클릭시 @click="active = !active"로 주게 되면
      토글처럼 활용할 수 있다</v-card
    >
